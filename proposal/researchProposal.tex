...
\subsection{Hypothesis testing}
	...
	Finally, to answer research question \ref{rq3} we formulate following hypotheses:
	...
	We use a two-tailed t-test to determine if $H_0$ can be rejected at the 0.05 significance level. With $H_0$ rejected, we find evidence for answering research question \ref{rq3} in the \textit{negative}. To answer research question \ref{rq3} in the affirmative the null hypothesis should be confirmed. And if that is the case we can more confidently interchange the augmented and non-augmented models.
