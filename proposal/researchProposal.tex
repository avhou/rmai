...
\subsection{Hypothesis testing}
	...
	For research question \ref{rq1} we formulate following null hypothesis:
	
	
	\begin{itemize}
		\item $H_0$: the mean number of vehicles detected by the baseline model ($\mu_1$) is identical with the mean number of vehicles detected by the augmented model ($\mu_2$), that is $\mu_1 = \mu_2$. 
	\end{itemize}
