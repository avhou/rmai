...
# ----------------------------------------------------
# ru.compare("Base", "DAWN", {"Base": base_predictions, "DAWN": scen_1_predictions})
# print("\n\n")
# ru.compare("Base", "DETRAC", {"Base": base_predictions, "DETRAC": scen_2_predictions})
# print("\n\n")
# ru.compare("DETRAC", "DAWN", {"DAWN": scen_1_predictions, "DETRAC": scen_2_predictions})
